    ...
    >
      ...
      <div className="relative glass max-w-lg w-full rounded-2xl p-7 max-h-[85vh] overflow-y-auto">
        <button
          ...
          className="absolute top-3 right-3 z-10 h-8 w-8 inline-flex items-center justify-center rounded-full bg-black/60 backdrop-blur-sm border border-white/15 text-sub hover:text-ink hover:bg-black/80 hover:border-white/30 transition cursor-pointer"
        >
